...
public class ArgumentParserTest {
	...
	public void testNoFlags() {
		final ArgumentParser parser = new ArgumentParser(new String[] {"GOOGL","COF"});
		assertEquals(DEFAULT_START_DATE, parser.getStartDate());
		assertEquals(DEFAULT_END_DATE, parser.getEndDate());
	...
	public void testHelp() {
		final ArgumentParser parser = new ArgumentParser(new String[] {"-help","GOOGL","COF"});
		assertTrue(parser.getTickers().isEmpty());
	}

	@Test
	public void testMaxProfit() {
		final ArgumentParser parser = new ArgumentParser(new String[] {"-profit","GOOGL","COF"});
		assertEquals(asList("GOOGL","COF"),parser.getTickers());
	...
	public void testBusy() {
		final ArgumentParser parser = new ArgumentParser(new String[] {"-busy","GOOGL","COF"});
		assertEquals(asList("GOOGL","COF"),parser.getTickers());
		assertTrue(parser.showBusiestDay());
	}
	@Test
	public void testBiggestLoser() {
		final ArgumentParser parser = new ArgumentParser(new String[] {"-loser","GOOGL","COF"});
		assertEquals(asList("GOOGL","COF"),parser.getTickers());
